...
RUN curl -O https://github.com/punkstar/mageconfigsync/releases/download/0.5.0-beta.1/mageconfigsync-0.5.0-beta.1.phar && chmod +x ./mageconfigsync-0.5.0-beta.1.phar && mv ./mageconfigsync-0.5.0-beta.1.phar /usr/local/bin/mageconfigsync.phar
